...
import { IPlaylistListResponse,IPlaylist } from "./types";
...
export class PlaylistsHttpSvc {
     ...
     * request parameters. For example, you can retrieve all
     * playlists that the authenticated user owns, or you can
     * retrieve one or more playlists by their unique IDs.
     * @param { string } channelId This value indicates that the API should only return the
     ...
     *        YouTube playlist ID(s) for the resource(s) that are being
     *        retrieved. In a playlist resource, the id property
     *        specifies the playlist's YouTube playlist ID.
     ...
     *        or more playlist resource properties that the API response
     *        will include.
     *        
     *        If the parameter identifies a property that contains child
     *        properties, the child properties will be included in the
     *        response. For example, in a playlist resource, the snippet
     *        property contains properties like author, title,
    ...
    public youtube_playlists_list(
         ...
         prettyPrint:boolean ,
         quotaUser:string ,
         userIp:string ):Promise<IPlaylistListResponse>{
        const params = {
            "channelId":channelId,
            "hl":hl,
            "id":id,
        ...
        return new Promise<IPlaylistListResponse>((resolve, reject) => {
            superAgentRequest
            ...
            .end(function(error, res){
                if(error){
                   ...
                   resolve(res.body as IPlaylistListResponse);
                }
            });
        });
    }
    /**
     * Modifies a playlist. For example, you could change a
     * playlist's title, description, or privacy status.
     * @param { IPlaylist } body 
     * @param { string } onBehalfOfContentOwner Note: This parameter is intended exclusively for YouTube
     *        content partners.
     *        
     *        The onBehalfOfContentOwner parameter indicates that the
     ...
     *        request body specifies. For example, a playlist's
     *        description is contained in the snippet part, which must be
     *        included in the request body. If the request does not
     *        specify a value for the snippet.description property, the
     ...
     * @param { string } userIp Deprecated. Please use quotaUser instead.
     */
    public youtube_playlists_update(
         body:IPlaylist ,
         onBehalfOfContentOwner:string ,
         part:string ,
         alt:string ,
         ...
         prettyPrint:boolean ,
         quotaUser:string ,
         userIp:string ):Promise<IPlaylist>{
        const params = {
            "onBehalfOfContentOwner":onBehalfOfContentOwner,
            "part":part,
            "alt":alt,
     ...
     * @param { string } userIp Deprecated. Please use quotaUser instead.
     */
    public youtube_playlists_insert(
         body:IPlaylist ,
         onBehalfOfContentOwner:string ,
         onBehalfOfContentOwnerChannel:string ,
         part:string ,
     ...
     *        playlist that is being deleted. In a playlist resource, the
     ...
     * @param { string } userIp Deprecated. Please use quotaUser instead.
     */
    public youtube_playlists_delete(
         id:string ,
         onBehalfOfContentOwner:string ,
         alt:string ,
         fields:string ,
